...
Partial Public Class peopleDataSet
    ...
    Partial Public Class PeopleDataTable
        ...
        Public Overloads Function AddPeopleRow( _
                    ...
                    ByVal Password As String) As PeopleRow
            Dim rowPeopleRow As PeopleRow = CType(Me.NewRow,PeopleRow)
            Dim columnValuesArray() As Object = New Object() {ID, Onoma, Epitheto, Hm_Gennisis, Baros, Ypsos, Fylo, Xrwma_Matiwn, Xrwma_Malliwn, Hoby1, Hoby2, Hoby3, Anazita, email, Glwssa, Glwssa2, Tatoo, Ergasia, Perioxh, Password}
